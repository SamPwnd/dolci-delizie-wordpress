...
module.exports = {
	// Project Identity
	appName: 'storefront', // Unique name of your project
	type: 'theme', // Plugin or theme
	slug: 'storefront', // Plugin or Theme slug, basically the directory name under `wp-content/<themes|plugins>`
