...
module.exports = {
	// Project Identity
	appName: 'storefrontChild', // Unique name of your project
	type: 'theme', // Plugin or theme
	slug: 'storefront-child', // Plugin or Theme slug, basically the directory name under `wp-content/<themes|plugins>`
	// Used to generate banners on top of compiled stuff
	bannerConfig: {
		name: 'storefrontChild',
		author: '',
		license: 'UNLICENSED',
		link: 'UNLICENSED',
		version: pkg.version,
