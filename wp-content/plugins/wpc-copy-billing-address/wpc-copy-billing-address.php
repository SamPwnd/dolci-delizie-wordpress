...
! defined( 'WPCCB_VERSION' ) && define( 'WPCCB_VERSION', '1.1.4' );
			...
			class WPCleverWpccb {
				...
				function __construct() {
					...
					add_action( 'before_woocommerce_init', function () {
						if ( class_exists( '\Automattic\WooCommerce\Utilities\FeaturesUtil' ) ) {
							FeaturesUtil::declare_compatibility( 'custom_order_tables', WPCCB_FILE );
						}
					} );
				}
				...
				function admin_menu_content() {
                    ...
                    <div class="wpclever_settings_page wrap">
                        <h1 class="wpclever_settings_page_title"><?php echo esc_html__( 'WPC Copy Billing Address', 'wpc-copy-billing-address' ) . ' ' . WPCCB_VERSION; ?></h1>
                        <div class="wpclever_settings_page_desc about-text">
                            <p>
								<?php printf( esc_html__( 'Thank you for using our plugin! If you are satisfied, please reward it a full five-star %s rating.', 'wpc-copy-billing-address' ), '<span style="color:#ffb900">&#9733;&#9733;&#9733;&#9733;&#9733;</span>' ); ?>
                                <br/>
                        ...
                        <div class="wpclever_settings_page_nav">
                            <h2 class="nav-tab-wrapper">
                                <a href="<?php echo admin_url( 'admin.php?page=wpclever-wpccb&tab=settings' ); ?>" class="<?php echo esc_attr( $active_tab === 'settings' ? 'nav-tab nav-tab-active' : 'nav-tab' ); ?>">
                                ...
                                <form method="post" action="options.php">
                                    <table class="form-table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="wpccb_settings[confirm]">
                                        ...
                                        <tr class="heading">
                                            <th colspan="2"><?php esc_html_e( 'Suggestion', 'wpc-copy-billing-address' ); ?></th>
                                        </tr>
                                        <tr>
                                            <td colspan="2">
				...
				function action_links( $links, $file ) {
					...
					if ( $plugin === $file ) {
						$settings = '<a href="' . admin_url( 'admin.php?page=wpclever-wpccb&tab=settings' ) . '">' . esc_html__( 'Settings', 'wpc-copy-billing-address' ) . '</a>';
