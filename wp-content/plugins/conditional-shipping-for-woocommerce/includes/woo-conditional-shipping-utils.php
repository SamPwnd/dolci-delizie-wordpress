...
function woo_conditional_shipping_operators() {
  return array(
    ...
    'in' => __( 'include', 'woo-conditional-shipping' ),
    'exclusive' => __( 'include only', 'woo-conditional-shipping' ),
    'notin' => __( 'exclude', 'woo-conditional-shipping' ),
    'allin' => __( 'include all', 'woo-conditional-shipping' ),
...
function wcs_get_price_modes() {
  ...
  return [
    ...
    'per_weight_unit' => sprintf( __( '%s per %s', 'woo-conditional-shipping' ), $currency_symbol, get_option( 'woocommerce_weight_unit' ) ),
    'per_piece' => sprintf( __( '%s per piece', 'woo-conditional-shipping' ), $currency_symbol ),
    'pct' => __( '% of subtotal', 'woo-conditional-shipping' ),
    'pct_shipping' => __( '% of shipping', 'woo-conditional-shipping' ),
  ];
}
  ...
  return apply_filters( 'woo_conditional_shipping_filters', array(
    'cart' => array(
      ...
      'filters' => array(
        ...
        'product_tags' => [
          'title' => __( 'Product Tags', 'woo-conditional-shipping' ),
...
function woo_conditional_shipping_get_shipping_method_options() {
  ...
  foreach ( $shipping_zones as $shipping_zone ) {
    ...
    $options['_all'] = [
      'title' => __( 'General', 'woo-conditional-shipping' ),
      'options' => [
        '_all' => [
          'title' => __( 'All shipping methods', 'woo-conditional-shipping' )
        ],
        '_name_match' => [
          'title' => __( 'Match by name', 'woo-conditional-shipping' )
        ],
      ],
    ];
...
function wcs_get_control_title( $control ) {
  if ( isset( $control['pro'] ) && $control['pro'] ) {
    return sprintf( __( '%s (Pro)', 'woo-conditional-shipping' ), $control['title'] );
  }
